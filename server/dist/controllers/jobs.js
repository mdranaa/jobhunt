...
exports.uploadJobImage = exports.deleteJob = exports.updateJob = exports.getJob = exports.getJobs = exports.createJob = void 0;
...
const createJob = async (req, res) => {
    try {
        const { title, description, salary, category, company, location, applicationDeadline } = req.body;
        let imageUrl = '';
        let imagePublicId = '';
        if (req.file) {
